...
const STATS = [
  { to: 36, label: "فصل ساختاریافته" },
  { to: 145, label: "صفحهٔ رنگی PDF" },
  { to: 2, label: "مسیر: CLI و VS Code" },
  { to: 4, label: "مینی‌پروژهٔ کارگاه" },
  { to: 20, suffix: "+", label: "اشتباه رایج با راه‌حل" },
];
