/**
 * Official Git logomark (orange, for light backgrounds) — exact paths from
 * git-scm.com/downloads/logos ("Git-Icon-1788C"). Git Logo by Jason Long,
 * licensed under CC BY 3.0 (credit in README).
 */
export default function GitMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 78 78" aria-hidden="true" className={className}>
      <path
        fill="#f03c2e"
