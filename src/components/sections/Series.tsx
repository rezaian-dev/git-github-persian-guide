...
const SERIES = [
  ...
  { badge: "RE", title: "React 19.2", text: "رابط کاربری، state و معماری کامپوننت", href: "https://rezaian-dev.github.io/react-19-persian-guide/" },
  { badge: "NX", title: "Next.js 16", text: "فریم‌ورک، رندر سرور و استقرار", href: "https://rezaian-dev.github.io/nextjs-16-persian-guide/" },
  { badge: "GIT", title: "Git & GitHub 2026", text: "نسخه‌بندی، VS Code و همکاری روی GitHub", href: "#top", current: true },
];
    ...
    <section className="py-24 md:py-32" id="series">
      <div className="container">
        <SectionHeader
          ...
          lead="Git برای همکاری؛ JavaScript برای زبان؛ React برای رابط؛ Next.js برای Production."
        />
