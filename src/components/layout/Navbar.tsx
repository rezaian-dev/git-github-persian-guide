...
import { PDF_URL, REPO_URL } from "@/lib/links";
...
const LINKS = [
  ...
  { href: "#chapters", label: "فصل‌ها", icon: ListTree, hint: "۳۶ فصل" },
  { href: "#editions", label: "نسخه‌ها", icon: Download, hint: "PDF · EPUB · وب" },
        ...
        {open && (
          <m.div className="fixed inset-0 z-50 lg:hidden" initial="hidden" animate="show" exit="exit">
            ...
            >
              ...
              <span
                aria-hidden="true"
                className="pointer-events-none absolute -top-24 end-[-20%] size-72 rounded-full bg-[radial-gradient(circle,rgb(255_106_43_/_0.22),transparent_70%)] blur-2xl"
              />
